              ...
              <tr key={cat._id} className="hover:bg-[#F4A460]/10 transition">
                ...
                <td className="px-6 py-4 text-center space-x-2">
                  <button
                    ...
                    className="px-3 py-1 text-sm text-[#A0522D] border border-[#A0522D] rounded hover:bg-[#A0522D]/10 transition"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => handleDelete(cat)}
                    className="px-3 py-1 text-sm text-[#E35336] border border-[#E35336] rounded hover:bg-[#E35336]/10 transition"
                  >
                    Delete
                  </button>
                </td>
