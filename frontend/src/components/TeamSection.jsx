  ...
  const chefs = [
    {
      ...
      name: "Chef Robert",
      role: "Brownie Chef",
      image: "/brownieeeeee.jpg",
    },
    {
      id: 2,
      name: "Chef Daniel",
      role: "Coffee Specialist",
      image: "/coffeeeeeeee.jpg",
    },
    {
      id: 3,
      name: "Chef Sophia",
      role: "Cupcake & Dessert Chef",
      image: "/cupcakeeeeee.jpg",
    },
    {
      id: 4,
      name: "Chef Sophia",
      role: "Cake Chef",
      image: "/lady-cakeeeee.jpg",
    },
  ];
  ...
  return (
    <section className="relative py-20 px-6 bg-gradient-to-br from-[#FFF6EC] via-[#FDEBD3] to-[#FAE1DD] overflow-hidden">
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold text-[#3B2F2F]">
          Meet Our Chefs
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
          Our talented team brings passion, creativity, and love into every
          dessert we create.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {chefs.map((chef) => (
          ...
          >
            ...
            {/* Role */}
            <p className="mt-2 text-[#A0522D] font-medium">
              {chef.role}
            </p>
          </div>
        ))}
